...
export default function App() {
  return (
    <div className="mx-auto flex min-h-screen max-w-[1280px] flex-col px-[clamp(20px,3.5vw,44px)] pt-[30px] pb-[18px]">
      ...
      <footer className="mt-auto flex flex-wrap items-center justify-between gap-3 border-t border-line pt-3.5 font-mono text-[11px] text-ink-3">
